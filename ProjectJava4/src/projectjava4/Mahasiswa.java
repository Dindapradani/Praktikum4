...
class Mahasiswa {
    ...
    ArrayList<Date> DataTgllahir = new ArrayList<>();
    ...
    void menu() throws ParseException {
        while (true) {
            ...
            System.out.println("Data Mahasiswa Saya");
        ...
        System.out.println("Silakan Masukan Nomor pilihan Anda");
        System.out.println("**********************************************");
        ...
        if(pilihan==1){
            ...
            System.out.println("TTL     : "+ DataTgllahir.get(index));
        ...
        System.out.println("**********************************************");
        if (DataNim.isEmpty()){
            System.out.println("Tidak Ada Data Mahasiswa yang Dicari");
            System.out.println(" ");
        }else{
            for (int i=0; i<DataNim.size(); i++){
                ...
                System.out.println("TTL     : "+ DataTgllahir.get(i));
                System.out.println("Gender  : " +  Lp);
            }
            System.out.println("");
            System.out.println("**********************************************");
            System.out.println("Jumlah Mahasiswa \t: "+ DataNim.size());
            System.out.println("**********************************************");
            System.out.println(" ");
        } 
    }void keluar(){
